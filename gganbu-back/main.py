...
def recognize_from_microphone():
    ...
    speech_config = speechsdk.SpeechConfig(
        subscription='dd2ac0f3da614f239fbb400eb4b1d29d', region='koreacentral')
...
def tracking():
    ...
    while flag:
        ...
        while True:
            ...
            for (x, y, w, h) in box:
                ...
                cv2.putText(frame, "Object Detected", (x + 5, y + 15),
    ...
    # 장고 리턴값을 유형별로 분기해서 나누어 주어야 한다.(while문이 끝나고 각각의 상태별로 리턴값을 보내줘야한다. ex)1-트래킹중 대상물체 인식실패가 3초 넘은 경우 )
    returnState = 0
    failCount = 0
    while cap.isOpened():
        global isWaiting
